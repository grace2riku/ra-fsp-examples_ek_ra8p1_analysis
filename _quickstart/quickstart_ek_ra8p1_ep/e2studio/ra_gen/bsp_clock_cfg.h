...
#define BSP_CFG_PLL2P_FREQUENCY_HZ (1200000000) /* PLL2P 1200000000Hz */
...
#define BSP_CFG_SCICLK_DIV (BSP_CLOCKS_SCI_CLOCK_DIV_5) /* SCICLK Div /5 */
...
#define BSP_CFG_OCTACLK_DIV (BSP_CLOCKS_OCTA_CLOCK_DIV_5) /* OCTACLK Div /5 */
