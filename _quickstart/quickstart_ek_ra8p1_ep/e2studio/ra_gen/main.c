...
extern void main_menu_thread_create(void);
extern TaskHandle_t main_menu_thread;
extern void board_mon_thread_create(void);
extern TaskHandle_t board_mon_thread;
extern void tp_thread_create(void);
extern TaskHandle_t tp_thread;
